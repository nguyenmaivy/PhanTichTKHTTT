        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    <h2 class="section-title px-5 mb-3"><span class="bg-secondary px-2">Cập nhật làm đẹp</span></h2>
                    <p>"Làm đẹp không phải là xa xỉ, đó là cách bạn yêu chính mình"</p>
                </div>
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control border-white p-4" placeholder="Nhận Email ở đây">
                        <div class="input-group-append">
                            <button class="btn btn-primary px-4">Đăng ký nhận tin</button>
                        </div>
                    </div>
                </form>
            </div>
